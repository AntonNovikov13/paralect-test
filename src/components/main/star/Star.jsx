...
import { handleToggleFavorite } from '../../../service/service';

export const Star = ({ id, vacancy, favorites, setFavorites }) => {
    return (
        <div
            onClick={() =>
                handleToggleFavorite(vacancy, favorites, setFavorites)
            }
        ...
        >
            <svg
                ...
                viewBox='0 0 22 20'
                fill={
                    favorites.some((vacancy) => vacancy.id === id)
                        ? '#5E96FC'
                        : 'none'
                }
                xmlns='http://www.w3.org/2000/svg'
                className='addtoFavorite_btn'
            >
                <path
